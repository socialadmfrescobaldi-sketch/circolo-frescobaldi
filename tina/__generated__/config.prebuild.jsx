...
var config_default = defineConfig({
  branch: "main",
  clientId: null,
  // per ora lavoriamo in locale, niente TinaCloud ancora
  token: null,
  build: {
    outputFolder: "admin",
    publicFolder: "public"
        ...
        fields: [
          {
            ...
            fields: [
              ...
              { type: "string", name: "cv", label: "Link al CV (PDF), lascia vuoto se non c'\xE8" }
            ]
          }
        ]
      },
        ...
        fields: [
          {
            ...
            fields: [
              ...
              { type: "string", name: "alt", label: "Descrizione (per accessibilit\xE0)" }
            ]
          }
        ]
      },
